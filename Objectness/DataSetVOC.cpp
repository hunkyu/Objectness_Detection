...
DataSetVOC::DataSetVOC(CStr &_wkDir)
{
	...
	imgPathW = "F:/Datasets/RoadMarkingDataset/%s.jpg";
	annoPathW = "F:/Dropbox/Coding/read_label/read_label/annotation/%s.yml";
	CmFile::MkDir(resDir);
	CmFile::MkDir(localDir);

	//trainSet = CmFile::loadStrList(wkDir + "ImageSets/Main/Train.txt");
	//testSet = CmFile::loadStrList(wkDir + "ImageSets/Main/car_testm.txt");
	trainSet = CmFile::loadStrList("modelFile/train.txt");
	testSet = CmFile::loadStrList("modelFile/test.txt");
